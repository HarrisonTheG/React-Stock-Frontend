...
import SearchStock from '../Search_Stock/SearchStock.js'
...
function MyTabs() {
  ...
  return (
    <Box display="flex" sx={{ width: '100%' }} borderColor="divider" borderBottom={1} border={1} paddingLeft="40px" bgcolor="#FFFFFF">
